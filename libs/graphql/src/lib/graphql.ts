...
import { getClient } from "@the-heights/apollo-client";
  ...
  export const GetPosts = async ({first}: GetPostsQueryVariables, tags = ['posts']) => {
    const GetPosts = unstable_cache(async (first) => {
  ...
  export const GetPostBySlug = async ({slug}: GetPostBySlugQueryVariables, tags = ['posts']) => {
    const GetPostBySlug = unstable_cache(async (slug) => {
  ...
  export const GetPostsByCat = async ({first, categoryName}: GetPostsByCatQueryVariables, tags = ['posts']) => {
    const GetPostsByCat = unstable_cache(async (first, categoryName) => {
  ...
  export const SearchPosts = async ({first, search, after}: SearchPostsQueryVariables, tags = ['posts']) => {
    const SearchPosts = unstable_cache(async (first, search, after) => {
