...
export enum MediaItemSizeEnum {
  ...
  /** MediaItem with the authorship-box-avatar size */
  AuthorshipBoxAvatar = 'AUTHORSHIP_BOX_AVATAR',
  /** MediaItem with the authorship-box-related size */
  AuthorshipBoxRelated = 'AUTHORSHIP_BOX_RELATED',
  /** MediaItem with the authorship-post-cards size */
  AuthorshipPostCards = 'AUTHORSHIP_POST_CARDS',
  /** MediaItem with the authorship-post-flat size */
  AuthorshipPostFlat = 'AUTHORSHIP_POST_FLAT',
  /** MediaItem with the authorship-post-thumbs size */
  AuthorshipPostThumbs = 'AUTHORSHIP_POST_THUMBS',
  /** MediaItem with the blog_thumbnail size */
...
export enum MenuLocationEnum {
  /** Put the menu in the footer_navi location */
  FooterNavi = 'FOOTER_NAVI',
  /** Put the menu in the lang_navi location */
  LangNavi = 'LANG_NAVI',
  /** Put the menu in the primary_navi location */
  PrimaryNavi = 'PRIMARY_NAVI',
}
...
export enum PostStatusEnum {
  ...
  /** Objects with the inherit status */
  Inherit = 'INHERIT',
  /** Objects with the negated status */
  Negated = 'NEGATED',
  ...
  /** Objects with the trash status */
  Trash = 'TRASH',
  /** Objects with the wpca_except status */
  WpcaExcept = 'WPCA_EXCEPT',
  /** Objects with the wpca_or status */
  WpcaOr = 'WPCA_OR',
}
...
export type Settings = {
  ...
  /** Settings of the the string Settings Group */
  themeisleSdkSettingsSettingsThemeisleSdkPromotions?: Maybe<
    Scalars['String']['output']
  >;
  /** Settings of the the boolean Settings Group */
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsNeveFseInstalled?: Maybe<
    Scalars['Boolean']['output']
  >;
  /** Settings of the the boolean Settings Group */
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsOptimoleInstalled?: Maybe<
    Scalars['Boolean']['output']
  >;
  /** Settings of the the boolean Settings Group */
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsOtterInstalled?: Maybe<
    Scalars['Boolean']['output']
  >;
  /** Settings of the the boolean Settings Group */
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsRopInstalled?: Maybe<
    Scalars['Boolean']['output']
  >;
  /** Settings of the the integer Settings Group */
...
/** The template assigned to the node */
export type Template_GalleryPage = ContentTemplate & {
  __typename?: 'Template_GalleryPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
export type UpdateSettingsInput = {
  ...
  pdfpSettingsSettingsBpmGutenbergEnable?: InputMaybe<
    Scalars['Boolean']['input']
  >;
  pdfpSettingsSettingsPdfpGutenbergEnable?: InputMaybe<
    Scalars['Boolean']['input']
  >;
  /** The ID of the page that should display the latest posts */
  ...
  themeisleSdkSettingsSettingsThemeisleSdkPromotions?: InputMaybe<
    Scalars['String']['input']
  >;
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsNeveFseInstalled?: InputMaybe<
    Scalars['Boolean']['input']
  >;
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsOptimoleInstalled?: InputMaybe<
    Scalars['Boolean']['input']
  >;
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsOtterInstalled?: InputMaybe<
    Scalars['Boolean']['input']
  >;
  themeisleSdkSettingsSettingsThemeisleSdkPromotionsRopInstalled?: InputMaybe<
    Scalars['Boolean']['input']
  >;
...
export type PostFragementFragment = {
  __typename?: 'Post';
  title?: string | null;
  id: string;
  date?: string | null;
...
export type GetPostIDsQuery = {
  __typename?: 'RootQuery';
  posts?: {
    __typename?: 'RootQueryToPostConnection';
    nodes: Array<{ __typename?: 'Post'; id: string }>;
  } | null;
};
...
export function useGetPostIDsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetPostIDsQuery,
    GetPostIDsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetPostIDsQuery, GetPostIDsQueryVariables>(
    GetPostIDsDocument,
    options
  );
}
export function useGetPostIDsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetPostIDsQuery, GetPostIDsQueryVariables>(
    GetPostIDsDocument,
    options
  );
}
export function useGetPostIDsSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetPostIDsQuery, GetPostIDsQueryVariables>(
    GetPostIDsDocument,
    options
  );
}
export type GetPostIDsQueryHookResult = ReturnType<typeof useGetPostIDsQuery>;
export type GetPostIDsLazyQueryHookResult = ReturnType<
  typeof useGetPostIDsLazyQuery
>;
export type GetPostIDsSuspenseQueryHookResult = ReturnType<
  typeof useGetPostIDsSuspenseQuery
>;
export type GetPostIDsQueryResult = Apollo.QueryResult<
  GetPostIDsQuery,
  GetPostIDsQueryVariables
>;
